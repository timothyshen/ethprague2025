  ...
  const stake = async (amount: string) => {
    try {
      ...
      toast({
        ...
        description:
          "Your staking transaction has been submitted to the network",
      });
    } catch (error) {
  ...
  const unstake = async (amount: string) => {
    try {
      ...
      toast({
        ...
        description:
          "Your unstaking transaction has been submitted to the network",
      });
    } catch (error) {
  ...
  const claimRewards = async () => {
    try {
      ...
      toast({
        ...
        description:
          "Your claim rewards transaction has been submitted to the network",
      });
    } catch (error) {
      ...
      toast({
        ...
        description:
          "There was an error submitting your claim rewards transaction",
        variant: "destructive",
      });
    }
  };
